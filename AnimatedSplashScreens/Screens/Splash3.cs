            ...
            timer.Tick += delegate
            {
                ...
                switch (count)
                {
                    case 5:
                        ...
                        BackColor = Color.FromArgb(181, 206, 230);

                        break;

                    case 13:

                        BackColor = Color.FromArgb(253, 174, 162);

                        break;

                    case 21:

                        BackColor = Color.FromArgb(160, 210, 155);

                        break;

                    case 23:

                        BackColor = Color.FromArgb(85, 149, 252);
                ...
                if (count == 24)
                {
                    ...
                    bunifuTransition1.ShowSync(panel2, true, Animation.Transparent);
                    bunifuTransition1.ShowSync(bunifuButton2, true, Animation.Transparent);
                    bunifuTransition1.ShowSync(bunifuImageButton1, true, Animation.Transparent);
